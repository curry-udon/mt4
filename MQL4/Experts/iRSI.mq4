...
//---- input parameters
//Fast, Slow
extern int parameter1 = 9;
extern int parameter2 = 14;

extern int LongPoint = 30;
extern int ShortPoint = 70;
extern int LongExitPoint = 70;
extern int ShortExitPoint = 30;
...
int start()
{
   ...
   FastLine2 = iCustom(NULL,0,"RSI",parameter1,0,2);
   SlowLine2 = iCustom(NULL,0,"RSI",parameter2,0,2);
   FastLine1 = iCustom(NULL,0,"RSI",parameter1,0,1);
   SlowLine1 = iCustom(NULL,0,"RSI",parameter2,0,1);
