...
double Heiken_Open_3 = 0;
double Heiken_Close_3 = 0;
...
//---added----------------------- 
   ...
   Heiken_Open_3 = iCustom(NULL,0,"Heiken Ashi",0,3);
   Heiken_Close_3 = iCustom(NULL,0,"Heiken Ashi",3,3);
...
//---added-----------------------
   ...
   // 買いポジションのエグジット
   if(   Heiken_Open_3 <= Heiken_Close_3
      && Heiken_Open_2 > Heiken_Close_2
